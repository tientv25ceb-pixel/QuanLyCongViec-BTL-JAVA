...
import client.util.ProtocolUtil;
...
public class ServerConnector {
    ...
    public Response sendRequest(Request request) {
        ...
        try {
            ...
            socket.connect(new InetSocketAddress(ClientConfig.getServerHost(), ClientConfig.getTcpPort()), CONNECT_TIMEOUT);
            ...
            e.printStackTrace();
            return new Response(false, "Lỗi kết nối hoặc timeout từ server: " + e.getMessage(), null,
